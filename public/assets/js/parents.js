function apiCallss() {
  ...
  var queryURL = 'https://www.eventbriteapi.com/v3/events/search/?location.address=maryland%2Cvirginia&categories=115&subcategories=15006&token=S6QQEW7L4B5Z4NSM6VOC';
  ...
  $.ajax({
    ...
    for (var i = 0; i < response.events.length; i++) {
      ...
      var html = "<div class ='card_container'>"
          ...
          // html += "<p> " + response.events[i].description.html + "</p>"
